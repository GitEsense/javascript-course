/_ Title: Модульность - домашнее задание Description: Создайте 3 файла: - user.js - содержит класс User, который в конструктор принимает Task и метод do(), который вызывает у Task метод run(). -
